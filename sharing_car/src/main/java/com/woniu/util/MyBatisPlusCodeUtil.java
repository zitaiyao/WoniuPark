...
public class MyBatisPlusCodeUtil {
    ...
    public static void main(String[] args) {
        try {
            generator("wdd",//作者
                    "jdbc:mysql://127.0.0.1:3306/sharing_car?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai",
                    "com.mysql.cj.jdbc.Driver",//数据库驱动
                    "root",//数据库帐号
                    "123456",//数据库密码
                    "com.woniu",//项目最大的包名
                    "sharing_car",//项目名或项目模块名
                    "account,admin,car,details,evaluation,lessor,parking,parking_order,perm,tenants");//要操作的表名,多个表名用逗号隔开
